      ...
      <main className="premium-container" style={{ flex: 1, padding: '120px 5vw', maxWidth: '800px' }}>
        ...
        <div style={{ color: 'var(--text-muted)', lineHeight: 1.6, fontSize: '1.1rem', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          <section>
            ...
            <p>Project QR operates on a zero-persistence architecture for routing data. When a QR anchor is scanned, we temporarily process IP addresses and device fingerprints strictly for security verification and rate-limiting. This metadata is volatile and is not stored permanently.</p>
          </section>
